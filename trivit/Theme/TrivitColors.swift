...
//  Trivit
//
//  Color themes for the app - replaces Colors.h/m
//
...
struct TrivitColors {
    ...
    // Main color palette (flat design inspired)
    ...
    static let paletteDark: [Color] = [
        Color(hex: "16A085"), // Green Sea
        Color(hex: "27AE60"), // Nephritis
        Color(hex: "2980B9"), // Belize Hole
        Color(hex: "8E44AD"), // Wisteria
        Color(hex: "C0392B"), // Pomegranate
        Color(hex: "D35400"), // Pumpkin
        Color(hex: "C2185B"), // Pink Dark
        Color(hex: "0097A7"), // Cyan Dark
        Color(hex: "689F38"), // Light Green Dark
        Color(hex: "E64A19"), // Deep Orange Dark
    ]
    ...
    static func darkColor(at index: Int) -> Color {
        let safeIndex = abs(index) % paletteDark.count
        return paletteDark[safeIndex]
    }

    static func randomColor() -> Color {
        palette.randomElement() ?? palette[0]
    }
